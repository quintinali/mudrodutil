...
public class SplitLogByIP extends SplitLogBase{
	...
	public List<String> splitLogs(JavaSparkContext sc, String httpfile,String ftpfile, int num) {
		...
		JavaPairRDD<String, Double> IPLineRDD = IPhttpLineRDD.leftOuterJoin(IPftpLineRDD).mapToPair(new PairFunction<Tuple2<String, Tuple2<Double, Optional<Double>>>, String, Double>() {
			@Override
			public Tuple2<String, Double> call(Tuple2<String, Tuple2<Double, Optional<Double>>> arg0)
					throws Exception {
		...
		//this.splitAllLog(accessLogs, IpGroups, num, httpfile);
	...
	private List<String> splitAllLog(JavaRDD<WebLog> logs, Map<String, Integer> IpGroups,int num, String httpfile,  String ftpfile){
		...
		}).filter(new Function<Tuple2<Integer,WebLog>,Boolean>(){
			@Override
			public Boolean call(Tuple2<Integer, WebLog> arg0) throws Exception {
				// TODO Auto-generated method stub
				if(arg0._1 == null){
					return false;
				}
